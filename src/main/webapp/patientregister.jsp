                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="PatientRegister">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="pemail" aria-describedby="emailHelp"
                                    required />
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" name="pphone" required />
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" id="pass" class="form-control" name="ppassword" id="password" required />
                            </div>
                            <div class="mb-3">
