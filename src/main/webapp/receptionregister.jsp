            ...
            <div class="col-md-8 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="ReceptionRegister">
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" class="form-control" name="rname" id="name" required />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" name="rphone" id="phone" required />
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" id="pass" name="rpassword" class="form-control" id="password" required />
                            </div>
                            <div class="mb-3">
