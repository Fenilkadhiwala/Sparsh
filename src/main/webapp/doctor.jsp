				...
				<div class="card">
					<div class="card-body">
						<div class="text-center mb-4">
							...
							<br> <br>
							<h3 class="card-title mt-3">Doctor Login</h3>
							<%
						...
						<form method="post" action="DoctorLogin">
							<div class="mb-3">
								<label for="username" class="form-label">Username</label> <input
									type="text" class="form-control" name="dname" id="username"
									required>
							</div>
							<div class="mb-3">
								<label for="password" class="form-label">Password</label> <input
									type="password" class="form-control" name="dpassword"
									id="password" required>
							</div>
							<div class="mb-3 form-check">
								<a href="doctorregister.jsp">Create an account</a> <br> <a
